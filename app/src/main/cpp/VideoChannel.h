...
public:
    VideoChannel(JavaCallHelper *helper,int id,AVCodecContext *context,AVRational time_base ,int fps);

    VideoChannel(JavaCallHelper helper, int id, AVCodecContext *avCodecContext,
